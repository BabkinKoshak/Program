 ...
 * @mainpage
 * # Загальне завдання
 * 1. **Переробити** програми, розроблені під час виконання лабораторних робіт з тем "Масиви" та "Цикли" так, щоб 
 * використовувалися функції для обчислення результату.
 * 2. **Реалізувати** функцію, яка перетворе задане число в рядок
 * 
 * @author Valkovskyi maksim
 * @date 14-dec-2020
 * @version 1.0
 */
